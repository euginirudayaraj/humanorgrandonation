...
<div id="bg1"><p>HUMAN ORGAN DONATION SYSTEM PORTAL </p></div>
	...
	<h2 align="center"> Donar Details</h2>
	 <form action="" method="post" name="form2">
	 <div align="center">Select Date &nbsp;  <input type="date" name="dates"> &nbsp;
       <input name="btn1" type="submit" id="btn1" value="Submit"></div>
 </form>
	...
	<tr>
		...
		if(isset($_POST['btn1']))
		{
		$qry=mysqli_query($conn,"select * from donate  where status='1' && date='$dates'");
		$i=1;

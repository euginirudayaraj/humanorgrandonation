...
<form id="form1" name="form1" method="post" action="">
	   <table width="46%" border="0" align="center">
         <tr>
           <td colspan="2" rowspan="1"><div align="center" class="style1"><strong><font size="+1">Donor Login</font> </div></td>
		 </tr>
			<tr>
		<td width="48%">&nbsp;</td>
		    <td width="52%">&nbsp;</td>
         ...
         <tr>
		  ...
		  <tr>
           ...
           <td align="center"><a href="register.php">New Donor Registration</a></td>
         </tr>

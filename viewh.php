...
<ul>
  ...
  <li><a href="viewd.php">View Donors</a></li>
   <li><a href="#">&nbsp;</a></li>
  <li><a class="active" href="viewh.php">View Hospitals</a></li>
  <li><a href="#">&nbsp;</a></li>
	...
	<tr>
		<td colspan="10">&nbsp;</td>
          ...
          <td width="3%"><div align="center" class="style6"><strong>Id</strong> </div></td>
		   <td width="10%"><div align="center" class="style6"><strong>Hospital Name</strong> </div></td>
		    <td width="9%"><div align="center" class="style6"><strong>Location</strong> </div></td>
			 ...
			 <td width="8%"><div align="center" class="style6"><strong>Phone</strong> </div></td>
			  <td width="8%"><div align="center" class="style6"><strong>Admin_name</strong> </div></td>
        </tr>
		<tr>
		<td colspan="10">&nbsp;</td>
		</tr>

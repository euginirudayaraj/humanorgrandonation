...
<ul>
	 <li><a href="#">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</a></li>
	  <li><a href="#">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</a></li>
  <li><a class="active" href="hhome.php">Hospital Home</a></li>
  <li><a href="#">&nbsp;</a></li>
  <li><a href="viewd.php">View Donors</a></li>
   <li><a href="#">&nbsp;</a></li>
		    ...
		    <td width="9%"><div align="center" class="style6"><strong>DOB</strong> </div></td>
			 ...
			 <td width="8%"><div align="center" class="style6"><strong>Occupation</strong> </div></td>
			  ...
			  <td width="11%"><div align="center" class="style6"><strong>Contact</strong> </div></td>
			   <td width="11%"><div align="center" class="style6"><strong>Accept</strong> </div></td>
        </tr>
		<tr>
		<td colspan="10">&nbsp;</td>
		</tr>
		<?php
		$qry=mysqli_query($conn,"select * from donate where hid='$hid' && status=''");
		$i=1;
		   ...
		   <td><div align="center"><?php echo $row1['name'];?></div></td>
			 ...
			 <td><div align="center"><?php echo $row1['phone'];?></div></td>
			   ...
			   <td><div align="center"><?php echo $row['rphone'];?></div></td>
			     <td width="9%"><div align="center"><a href="accept.php?did=<?php echo $row['id'];?>&phn=<?php echo $row['rphone'];?>">Accept</a></div></td>
